<?php
// hanapp_backend/api/reviews/get_doer_reviews.php
// Fetches all reviews for a specific doer
...
try {
    ...
    if (!$doerId) {
        throw new Exception("Doer ID is required.");
    }

    // Get reviews for the doer with lister details
    ...
    error_log("get_doer_reviews.php: Caught exception: " . $e->getMessage(), 0);
    echo json_encode([
        "success" => false,
