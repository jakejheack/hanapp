<?php
// hanapp_backend/api/notifications/mark_doer_read.php
...
try {
    ...
    $sql = "UPDATE doer_notifications SET is_read = 1 WHERE id = ?";
    ...
    error_log("mark_doer_read.php: Caught exception: " . $e->getMessage(), 0);
    echo json_encode([
        "success" => false,
