...
import 'package:hanapp/screens/lister/combined_listings_screen.dart'; // Import AuthService for logout
...
class _ListerDashboardScreenState extends State<ListerDashboardScreen> {
  ...
  Future<void> _logout() async {
    ...
    final videoPlayerState = _ListerHomeScreenContent.videoPlayerKey.currentState;
...
class _ListerHomeScreenContentState extends State<_ListerHomeScreenContent> {
  ...
  void initState() {
    super.initState();
    print('DEBUG: Lister Home Screen initState called');
    _loadVideos();
  }
  ...
  Widget _buildVideoContent() {
    ...
    return InlineVideoPlayer(
      key: _ListerHomeScreenContent.videoPlayerKey,
      video: _videos.first,
      autoplay: true,
